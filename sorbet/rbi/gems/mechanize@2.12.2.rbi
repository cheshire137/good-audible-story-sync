...
class Mechanize::HTTP::Agent
  ...
  # processing.
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1254
  ...
  # the response.
  #
  # source://mechanize//lib/mechanize/http/agent.rb#509
  ...
  # the response.
  #
  # source://mechanize//lib/mechanize/http/agent.rb#538
  def content_encoding_zstd(body_io); end
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#555
  def disable_keep_alive(request); end

  # source://mechanize//lib/mechanize/http/agent.rb#559
  ...
  # :section: Response
  #
  # source://mechanize//lib/mechanize/http/agent.rb#781
  def get_meta_refresh(response, uri, page); end

  # source://mechanize//lib/mechanize/http/agent.rb#1079
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#1275
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#1289
  def log; end

  # source://mechanize//lib/mechanize/http/agent.rb#1333
  ...
  # An OpenSSL private key or the path to a private key
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1182
  def private_key; end

  # Sets the client's private key
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1187
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#581
  def request_add_headers(request, headers = T.unsafe(nil)); end

  # source://mechanize//lib/mechanize/http/agent.rb#598
  def request_auth(request, uri); end

  # source://mechanize//lib/mechanize/http/agent.rb#614
  def request_auth_digest(request, uri, realm, base_uri, iis); end

  # source://mechanize//lib/mechanize/http/agent.rb#623
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#633
  def request_host(request, uri); end

  # source://mechanize//lib/mechanize/http/agent.rb#640
  def request_language_charset(request); end

  # Log specified headers for the request
  #
  # source://mechanize//lib/mechanize/http/agent.rb#645
  ...
  # major browsers do.
  #
  # source://mechanize//lib/mechanize/http/agent.rb#658
  def request_referer(request, uri, referer); end

  # source://mechanize//lib/mechanize/http/agent.rb#669
  def request_user_agent(request); end

  # source://mechanize//lib/mechanize/http/agent.rb#1347
  def reset; end

  # source://mechanize//lib/mechanize/http/agent.rb#673
  def resolve(uri, referer = T.unsafe(nil)); end

  # source://mechanize//lib/mechanize/http/agent.rb#764
  def resolve_parameters(uri, method, parameters); end

  # source://mechanize//lib/mechanize/http/agent.rb#796
  def response_authenticate(response, page, uri, request, headers, params, referer); end

  # source://mechanize//lib/mechanize/http/agent.rb#873
  def response_content_encoding(response, body_io); end

  # source://mechanize//lib/mechanize/http/agent.rb#919
  def response_cookies(response, uri, page); end

  # @raise [Mechanize::RedirectLimitReachedError]
  #
  # source://mechanize//lib/mechanize/http/agent.rb#947
  def response_follow_meta_refresh(response, uri, page, redirects); end

  # source://mechanize//lib/mechanize/http/agent.rb#961
  def response_log(response); end

  # source://mechanize//lib/mechanize/http/agent.rb#972
  def response_parse(response, body_io, uri); end

  # @raise [Mechanize::ResponseCodeError]
  #
  # source://mechanize//lib/mechanize/http/agent.rb#976
  def response_read(response, request, uri); end

  # @raise [Mechanize::RedirectLimitReachedError]
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1035
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#1099
  ...
  # @return [Boolean]
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1109
  ...
  # @return [Boolean]
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1117
  ...
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1123
  def robots_error(url); end

  # Raises the error if there is an error in fetching or parsing robots.txt of
  # the site +url+.
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1129
  def robots_error!(url); end
  ...
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1134
  def robots_reset(url); end

  # source://mechanize//lib/mechanize/http/agent.rb#935
  ...
  # source://mechanize//lib/mechanize/http/agent.rb#752
  ...
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1298
  ...
  # SSL version to use
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1198
  def ssl_version; end

  # Sets the SSL version to use
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1203
  def ssl_version=(ssl_version); end

  # @return [Boolean]
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1340
  ...
  # when the SSLContext was created
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1213
  def verify_callback; end

  # Sets the certificate verify callback
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1218
  def verify_callback=(verify_callback); end

  # How to verify SSL connections.  Defaults to VERIFY_PEER
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1223
  def verify_mode; end

  # Sets the mode for verifying SSL connections
  #
  # source://mechanize//lib/mechanize/http/agent.rb#1228
  def verify_mode=(verify_mode); end
...
# :section: Robots
#
# source://mechanize//lib/mechanize/http/agent.rb#1077
...
class Mechanize::Page < ::Mechanize::File
  ...
  #
  # source://mechanize//lib/mechanize/page.rb#527
  def bases; end
  ...
  # with href="canonical".
  #
  # source://mechanize//lib/mechanize/page.rb#179
  def canonical_uri; end

  # Get the content type
  #
  # source://mechanize//lib/mechanize/page.rb#190
  def content_type; end
  ...
  #
  # source://mechanize//lib/mechanize/page.rb#506
  def forms; end
  ...
  #
  # source://mechanize//lib/mechanize/page.rb#534
  def frames; end
  ...
  #
  # source://mechanize//lib/mechanize/page.rb#541
  def iframes; end
  ...
  # source://mechanize//lib/mechanize/page.rb#553
  def image_urls; end
  ...
  #
  # source://mechanize//lib/mechanize/page.rb#548
  def images; end
  ...
  #
  # source://mechanize//lib/mechanize/page.rb#559
  def labels; end

  # source://mechanize//lib/mechanize/page.rb#564
  def labels_hash; end
  ...
  #
  # source://mechanize//lib/mechanize/page.rb#496
  def links; end
  ...
  #
  # source://mechanize//lib/mechanize/page.rb#517
  ...
  # See also Nokogiri::XML::Node#at_xpath for details.
  #
  # source://mechanize//lib/mechanize/page.rb#110
  def parser; end

  # source://mechanize//lib/mechanize/page.rb#133
  def pretty_print(q); end

  # source://mechanize//lib/mechanize/page.rb#164
  def reset; end
  ...
  # source://mechanize//lib/mechanize/page.rb#630
  def html_body; end

  class << self
    # source://mechanize//lib/mechanize/page.rb#576
    ...
    #
    # source://mechanize//lib/mechanize/page.rb#598
    def meta_charset(body); end

    # Retrieves the last <tt>content-type</tt> set by a +meta+ tag in +body+
    #
    # source://mechanize//lib/mechanize/page.rb#616
    def meta_content_type(body); end

    # source://mechanize//lib/mechanize/page.rb#585
